...
export TQ_CONTROLLER_GET_METADATA_TIMEOUT=100
export TQ_CONTROLLER_GET_METADATA_CHECK_INTERVAL=5
...
EXPERIMENT_NAME="qwen2_5_vl_3b_tq"
...
PYTHONUNBUFFERED=1 python3 -m recipe.transfer_queue.main_ppo_mm \
    --config-path=${BASEDIR}/recipe/deepeyes/configs \
    --config-name='deepeyes_multiturn_grpo_tq' \
